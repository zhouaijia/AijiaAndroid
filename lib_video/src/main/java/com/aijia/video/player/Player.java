...
import com.aijia.video.player.source.Track.TrackType;
 ...
 * It's recommended to using {@link com.aijia.video.player.adapter.PlayerAdapter} to simplify
...
public interface Player {
     ...
     * {@link com.aijia.video.player.utils.event.Dispatcher.EventListener}
     * Player state event would be one of
     * <ul>
     *     <li>{@link com.aijia.video.player.event.StateIDLE} </li>
