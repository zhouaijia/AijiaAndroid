...
import com.aijia.video.engine.core.Resolution;

import java.util.LinkedHashMap;
import java.util.Map;
import java.util.Objects;

public class AQuality {
    ...
    static {
        MAP_COMMON.put(Resolution.Standard, AQuality.QUALITY_360P);
        MAP_COMMON.put(Resolution.High, AQuality.QUALITY_480P);
        MAP_COMMON.put(Resolution.SuperHigh, AQuality.QUALITY_720P);
        MAP_COMMON.put(Resolution.ExtremelyHigh, AQuality.QUALITY_1080P);
        MAP_COMMON.put(Resolution.FourK, AQuality.QUALITY_4K);
        //Resolution.HDR,
        //Resolution.Auto,
        MAP_COMMON.put(Resolution.L_Standard, AQuality.QUALITY_240P);
        MAP_COMMON.put(Resolution.H_High, AQuality.QUALITY_540P);
        MAP_COMMON.put(Resolution.TwoK, AQuality.QUALITY_2K);
        MAP.put(Resolution.ExtremelyHigh_50F, AQuality.QUALITY_1080P_50FPS);
        MAP.put(Resolution.TwoK_50F, AQuality.QUALITY_2K_50FPS);
        MAP.put(Resolution.FourK_50F, AQuality.QUALITY_4K_50FPS);
        MAP.put(Resolution.ExtremelyHigh_60F, AQuality.QUALITY_1080P_60FPS);
        MAP.put(Resolution.TwoK_60F, AQuality.QUALITY_2K_60FPS);
        MAP.put(Resolution.FourK_60F, AQuality.QUALITY_4K_60FPS);
        MAP.put(Resolution.ExtremelyHigh_120F, AQuality.QUALITY_1080P_120FPS);
        MAP.put(Resolution.TwoK_120F, AQuality.QUALITY_2K_120FPS);
        MAP.put(Resolution.FourK_120F, AQuality.QUALITY_4K_120FPS);
        MAP.put(Resolution.L_Standard_HDR, AQuality.QUALITY_240P_HDR);
        MAP.put(Resolution.Standard_HDR, AQuality.QUALITY_360P_HDR);
        MAP.put(Resolution.High_HDR, AQuality.QUALITY_480P_HDR);
        MAP.put(Resolution.H_High_HDR, AQuality.QUALITY_540P_HDR);
        MAP.put(Resolution.SuperHigh_HDR, AQuality.QUALITY_720P_HDR);
        MAP.put(Resolution.ExtremelyHigh_HDR, AQuality.QUALITY_1080P_HDR);
        MAP.put(Resolution.TwoK_HDR, AQuality.QUALITY_2K_HDR);
        MAP.put(Resolution.FourK_HDR, AQuality.QUALITY_4K_HDR);
        MAP.put(Resolution.EightK, AQuality.QUALITY_8K);
        MAP.put(Resolution.ExtremelyHighPlus, AQuality.QUALITY_1080P_PLUS);
