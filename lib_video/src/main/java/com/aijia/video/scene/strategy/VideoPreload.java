...
/**
 * Using {@link com.aijia.video.scene.ui.video.scene.shortvideo.ShortVideoStrategy}
 * and {@link  com.aijia.video.scene.ui.video.scene.feedvideo.FeedVideoStrategy} is
...
public class VideoPreload implements Dispatcher.EventListener {
    ...
    public static class Config {
        ...
        public Config(int scene) {
            this.scene = scene;
            //ToDo
            final JSONObject preloadConfig = null;//EngineStrategy.getPreloadConfig(scene);
    ...
    private void checkDiskCache(MediaSource source, Track selected) {
        ...
        //ToDo
        String cacheKey = null;//PlayerInit.getCacheKeyFactory().generateCacheKey(source, selected);
