...
import com.aijia.video.player.cache.CacheLoader;
...
import com.aijia.video.player.utils.FileUtils;
import com.aijia.video.scene.strategy.VideoQuality;
import com.aijia.video.settings.Option;
import com.aijia.video.settings.Options;
import com.aijia.video.settings.OptionsDefault;
import com.aijia.video.settings.SettingItem;
import com.aijia.video.settings.Settings;
...
public class VideoSettings {
    ...
    public static class CodecStrategy {
        public static final int CODEC_STRATEGY_DISABLE = Config.CODEC_STRATEGY_DISABLE;
        public static final int CODEC_STRATEGY_COST_SAVING_FIRST = Config.CODEC_STRATEGY_COST_SAVING_FIRST;
        public static final int CODEC_STRATEGY_HARDWARE_DECODE_FIRST = Config.CODEC_STRATEGY_HARDWARE_DECODE_FIRST;
    }
    ...
    private static void createCommonSettings(List<SettingItem> settings) {
        ...
        /*settings.add(SettingItem.createCopyableTextItem(CATEGORY_COMMON_VIDEO,
                "Device ID",
                new SettingItem.Getter(getDeviceId())
        ));*/
    ...
    private static String getDeviceId() {
        return "DE3HMUSF2VLL2Z3B3DQTSAVAOQ5YQOFEV32RQCWZFZ543CG763BA01";
    }
