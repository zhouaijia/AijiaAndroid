...
public class MoreDialogLayer extends DialogLayer {
    ...
    private List<Item> createItems(Context context) {
        ...
        items.add(new Item(Item.SHARE, R.string.vevod_more_dialog_item_share, R.drawable.more_dialog_layer_share_ic, false));
        items.add(new Item(Item.COLLECT, R.string.vevod_more_dialog_item_collect, R.drawable.more_dialog_layer_collect_ic_selecor, false));
        items.add(new Item(Item.DOWNLOAD, R.string.vevod_more_dialog_item_download, R.drawable.more_dialog_layer_download_ic_selector, false));
        items.add(new Item(Item.DANMAKU_CONFIG, R.string.vevod_more_dialog_item_danmaku, R.drawable.more_dialog_layer_danmaku_setting_ic, false));
        items.add(new Item(Item.RENDER_FULLSCREEN, R.string.vevod_more_dialog_item_full_width, R.drawable.more_dialog_layer_fullwidth_ic_selector, false));
        items.add(new Item(Item.PURE_AUDIO_MODE, R.string.vevod_more_dialog_item_audio_mode, R.drawable.more_dialog_layer_audio_mode_ic_selector, false));
        items.add(new Item(Item.BACKGROUND, R.string.vevod_more_dialog_item_play_background, R.drawable.more_dialog_layer_play_background_ic_selector, false));
        items.add(new Item(Item.TIMER, R.string.vevod_more_dialog_item_timer, R.drawable.more_dialog_layer_timer_ic_selector, false));
        items.add(new Item(Item.ASSIST_FUNC, R.string.vevod_more_dialog_item_assist_func, R.drawable.more_dialog_layer_assist_func_ic, false));
        items.add(new Item(Item.NOT_INTERESTED, R.string.vevod_more_dialog_item_not_interested, R.drawable.more_dialog_layer_not_interested_ic, false));
        items.add(new Item(Item.FEED_BACK, R.string.vevod_more_dialog_item_feedback, R.drawable.more_dialog_layer_feedback_ic, false));
        items.add(new Item(Item.REPORT, R.string.vevod_more_dialog_item_report, R.drawable.more_dialog_layer_report_ic, false));
