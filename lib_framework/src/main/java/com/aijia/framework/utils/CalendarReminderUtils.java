...
public class CalendarReminderUtils {
	...
	private static String CALENDARS_NAME = "aijia";
	private static String CALENDARS_ACCOUNT_NAME = "AIJIA@aijia.com";
	private static String CALENDARS_ACCOUNT_TYPE = "com.android.aijia";
	private static String CALENDARS_DISPLAY_NAME = "AIJIA账户";
