 ...
 * 反射通用类
 *
 * Created by Dicke.Zhou on 2022.4.16
 */
public final class ReflectUtils {
    ...
    private ReflectUtils(final Class<?> reflectClass) {
        this(reflectClass, reflectClass);
    }

    private ReflectUtils(final Class<?> reflectClass, Object classObject) {
        this.reflectClass = reflectClass;
    ...
    public ReflectUtils field(final String name) {
        try {
            ...
            return new ReflectUtils(field.getType(), field.get(classObject));
    ...
    public ReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
            field.set(classObject, unwrap(value));
            return this;
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    ...
    public ReflectUtils method(final String name, final Object... args) throws ReflectException {
        ...
        try {
            ...
            return method(method, classObject, args);
        } catch (NoSuchMethodException e) {
            try {
    ...
    public <P> P proxy(final Class<P> proxyType) {
        final boolean isMap = (classObject instanceof Map);
        final InvocationHandler handler = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) {
                ...
                try {
                    return reflect(classObject).method(name, args).get();
                } catch (ReflectException e) {
                    if (isMap) {
                        Map<String, Object> map = (Map<String, Object>) classObject;
    ...
    public boolean equals(Object obj) {
        return obj instanceof ReflectUtils && classObject.equals(((ReflectUtils) obj).get());
    }
    ...
    /**
     * 自定义反射异常类
     * 将所有不同的异常统一包装成 ReflectException 抛到上层，方便开发人员统一处理
     */
