...
//        setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        mIsDrawRound = true;//mTopLeftRadius != 0 || mTopRightRadius != 0 || mBottomLeftRadius != 0 || mBottomRightRadius != 0;
    ...
    protected void onSizeChanged(int width, int height, int oldw, int oldh) {
        ...
        initBreatheShadowView(width, height);
    ...
    private void initBreatheShadowView(int width, int height) {
        if (shadowView == null) {
